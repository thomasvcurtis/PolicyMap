function makeMap() {
  ...
  mapboxgl.accessToken =
    "pk.eyJ1IjoiY3JsaWxseSIsImEiOiJjbGY0YnBjbXEwcmd0M3NvNDQ0NzJrY243In0.y62PDs53srP8p8sj90g2XA";
  ...
  map.on("click", (event) => {
    ...
    document.getElementById("Current_Petition").innerHTML = `<h4>${title}</h4>
        <p>${description}</p>
